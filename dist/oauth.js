...
const TOKEN_URL = process.env.ANTHROPIC_TOKEN_URL ||
    "https://platform.claude.com/v1/oauth/token";
const REDIRECT_URI = process.env.ANTHROPIC_REDIRECT_URI ||
    "https://platform.claude.com/oauth/code/callback";
const SCOPES = process.env.ANTHROPIC_SCOPES ||
    "user:profile user:inference user:sessions:claude_code user:mcp_servers user:file_upload";
const CLI_VERSION = process.env.ANTHROPIC_CLI_VERSION || "2.1.81";
const USER_AGENT = process.env.ANTHROPIC_USER_AGENT ||
    `claude-cli/${CLI_VERSION} (external, cli)`;
const BETA_FLAGS = process.env.ANTHROPIC_BETA_FLAGS ||
